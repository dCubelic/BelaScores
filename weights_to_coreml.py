...
def _main(args):
    ...
    if args.weights_only:
        model.save_weights('{}'.format(output_path + '.h5'))
        print('Saved Keras weights to {}'.format(output_path + '.h5'))
    else:
        model.save('{}'.format(output_path + '.h5'))
        print('Saved Keras model to {}'.format(output_path + '.h5'))
    ...
    if args.plot_model:
        plot(model, to_file='{}.png'.format(output_root + '.h5'), show_shapes=True)
...
def convert_coreml():
    ...
    coreml_model.save(output_path + '.mlmodel')
